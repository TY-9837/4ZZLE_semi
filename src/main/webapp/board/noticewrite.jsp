...
<div id="con1">
	<div class="container" style="background-color: #121212;">
		<nav class="navbar navbar-expand navbar-light bg-light" style="background-color: #121212; padding: 0%; margin-bottom: 4%; font-weight: 700;">
            <div class="container-fluid" style="width: 100%; background-color: #121212; padding-top: 100px; ">
