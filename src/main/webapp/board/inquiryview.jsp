		...
		<div class="container" style="background-color: #121212;">
				...
				<div class="container-fluid"
					...
					<div class="collapse navbar-collapse" id="navbarNav"
						...
						<a class="nav-link active" aria-current="page"
							href="/list.board?cpage=1" style="color: #FFFFFF; width: 15%;">공지사항</a>
			...
			<form action="/update.qnaboard" method="post">
				...
				<div id="notice" align=center
					...
					<div id="row3"
					 ...
					 <div id="row4" style="width: 100%; margin-bottom: 0.4%;" align=right>
			...
			<c:choose>
				...
				<input type=hidden name="pseq" value=${dto.seq}>
					<div id="row5"
						style="width: 100%; height: 250px; border-top: 2px solid #2E2E2E; padding-top: 2%; padding-bottom: 2%;">
						...
						<div style="float: left; width: 20%;" align=center>
							<button class="btn" style="width: 50%; margin-top: 70px;">등록</button>
						</div>
					</div>
				</c:when>
			</c:choose>
		...
		<div id="row8">
			<div class="rcontainer" style="color: white;">
				<div id="rrow1">
					...
					<div id="rright" align="right">${i.write_date}</div>
				</div>
				<div id="rrow2">
