			...
			<div class="row">
				...
				<div class="container">
					<div class="row" align=center style="margin-bottom:5%;">
						...
						<div align=center>
						<img id="p5" src="/img/ott1fee.png" style="padding-top: 4%; padding-bottom: 4%; display: none;">
                		<img id="p6" src="/img/ott2fee.png" style="padding-top: 4%; padding-bottom: 4%; display: none;">
                		<img id="p7" src="/img/ott3fee.png" style="padding-top: 4%; padding-bottom: 4%; display: none;">
                		<img id="p8" src="/img/ott4fee.png" style="padding-top: 4%; padding-bottom: 4%; display: none;">
                		</div>
                		<div align=center>
                		<button id="next" class="bigbtn" style="display:none;">다음</button>
                		</div>
					</div>
				</div>
			</div>
	...
	<div id="con2" style="display:none;">
		<div class="container">
			<div class="row">
				...
				<button class="btns" id="p11" style="margin-left:3%; background:none;">퍼즐원</button>
				</div>
					<div id="role1">
                    <img id="p12" src="/img/leaderadd1.png" style="width: 50%; margin-top : 4%; margin-bottom: 4%;">
                    <img id="p13" src="/img/leaderadd2.png" style="width: 50%; margin-bottom: 4%;"><br>
                    <button id="leader" class="bigbtn" style="width:350px; margin-bottom: 4%;">퍼즐장으로 이용하기</button>
                	</div>
                	<div id="role2" style="display: none;">
                    <img id="p14" src="/img/memberadd1.png" style="width: 50%; margin-top : 4%; margin-bottom: 4%;"><br>
                    <button id="member" class="bigbtn" style="width:350px; margin-bottom: 4%;">퍼즐원으로 이용하기</button>
                </div>  
				</div>
			</div>
		</div>
