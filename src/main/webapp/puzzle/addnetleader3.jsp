    ...
    <div id="container" align=center>
        <div style="width: 50%; padding-top: 1%;">
            <div style="float: left; width: 50%;" align=left>
                <a href="/puzzle/addnetleader2.jsp"><img id="back" src="/img/back.png" style="width: 4%;"></a>
            </div>
        ...
        <div align=center style="width: 70%; padding-top: 4%;">
            <img src="/img/addnetleader4.png" style="padding-bottom: 5%; width: 50%;"><br>
            <div style="border-radius: 25px; border: none; background-color: #ffffff; width: 50%; height:50px; color: #121212; font-weight: bold; font-size: 20px; line-height: 45px; padding-left: 20px;" align=left>
                ID
            ...
            <div style="border-radius: 25px; border: none; background-color: #ffffff; width: 50%; height:50px; color: #121212; font-weight: bold; font-size: 20px; line-height: 45px; padding-left: 20px; margin-top: 1%;" align=left>
                PW
                <input id="pw" type="text" placeholder="넷플릭스 비밀번호 입력" name = "ottPw" style="border: none; background-color: #ffffff; width: 80%;">
            </div>
            <div style="width: 50%; margin-left: 2%; color: #ededed; padding-top: 1%; padding-bottom:5%;" align=left>공유 가능한 안전한 비밀번호를 사용해주세요</div>
            <input type="hidden" name="netflix" value="B">
            ...
            <button id="next" type="submit" class="bigbtn" onclick = "location.href = '/puzzle/addnetleader4.jsp'">다음</button>
        </div>
    </div>
    </form>
</body>
